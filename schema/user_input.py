...
class UserInput(BaseModel):
   ...
   income_lpa:Annotated[float,Field(...,description='income of user')]
   smoker:Annotated[bool,Field(...,description='IS user a smoker')]
   city:Annotated[str,Field(...,description='the city of the user')]
   occupation:Annotated[Literal['retired', 'freelancer', 'student', 'government_job',
       'business_owner', 'unemployed', 'private_job'],Field(...,description='whats the user occupation')]
...
#user input hamara hota ha jo hamne pydantic model banaya h use call krte h for validation
